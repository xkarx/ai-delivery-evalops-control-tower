...
import { configuredOperatorPasscode, isOperatorAuthorized, operatorSessionResponse } from "@/lib/operator-auth";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    authorized: await isOperatorAuthorized(),
    required: configuredOperatorPasscode()
  });
}
