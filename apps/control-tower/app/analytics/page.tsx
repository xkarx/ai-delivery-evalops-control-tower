...
export default async function AnalyticsPage() {
  ...
  return (
    <div className="page-container">
      <PageHeading eyebrow="Product intelligence" title="Product analytics" description="Deterministic traffic, persistent customers, funnel behavior, exposure, and release outcomes." actions={<ActionFeedbackButton message="Segmentation is read-only in V1; use the traffic controls below to change the observed cohort."><Filter size={15} /> Segment</ActionFeedbackButton>} />
