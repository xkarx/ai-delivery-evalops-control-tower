...
export default async function AnalyticsPage() {
  ...
  return (
    <div className="page-container">
      <PageHeading eyebrow="Product intelligence" title="Product analytics" description="Deterministic traffic, persistent customers, funnel behavior, exposure, and release outcomes." actions={<button className="button secondary"><Filter size={15} /> Segment</button>} />
