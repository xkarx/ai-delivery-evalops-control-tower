...
export default async function ReviewsPage() {
  ...
  return (
    <div className="page-container">
      <PageHeading eyebrow="Human control" title="Human review queue" description="Agents propose; authorized reviewers decide at feature, preview, and release boundaries." actions={<button className="button secondary"><Scale size={15} /> Calibration report</button>} />
