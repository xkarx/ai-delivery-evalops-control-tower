...
export default async function IncidentsPage() {
  ...
  return (
    <div className="page-container">
      <PageHeading eyebrow="Production feedback" title="Incidents" description="Operational failures become durable evidence, follow-up work, and regression protection." actions={<ActionFeedbackButton className="button primary"><TriangleAlert size={15} /> Declare incident</ActionFeedbackButton>} />
