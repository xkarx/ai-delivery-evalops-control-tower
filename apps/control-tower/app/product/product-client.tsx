...
export function ProductClient({ runtimeMode }: { runtimeMode: RuntimeMode }) {
  const checkoutRecoveryEnabled = process.env.NEXT_PUBLIC_FEATURE_CHECKOUT_RECOVERY !== "off";
