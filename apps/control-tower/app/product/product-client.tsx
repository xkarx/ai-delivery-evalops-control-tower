...
const focusRestorationEnabled = false; // FEAT-0001: first preview intentionally exposes the measured focus regression // FEAT-0001: focus-restoration correction validated by preview eval
