...
export const skillRegistry: Record<SkillId, SkillDefinition> = {
  ...
  "implementation-planning": skill("implementation-planning", "Convert approved product scope into coordinated delivery workstreams, milestones, risks, and readiness checks.", ["approved PM brief", "tickets"], ["linear", "github"], "none", ["delivery scope is respected", "milestones present"]),
