...
| 06 Control tower | Complete | local Next app | Playwright spec + Next build | Overview plus the required operational views, customer-product navigation, route-specific layouts (evals/incidents/analytics/company/features/lineage/releases/reviews/runs/settings), charts, review queue, health cards, responsive CSS, and executable Run demo/Reset scenario controls |
