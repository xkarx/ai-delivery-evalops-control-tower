...
| 06 Control tower | Complete | local Next app | Playwright + Next build | Overview plus the required operational views, first-visit Demo Guide, customer-product navigation, route-specific layouts, charts, review queue, health cards, responsive CSS, live mode explanation, operator authorization, replay/reset, and executable workflow controls |
