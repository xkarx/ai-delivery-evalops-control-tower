...
| 07 Integrations | Complete | mock/live adapters | `tests/connectors*.test.ts` | GitHub, Slack, Linear/GitHub Issues, Supabase, Langfuse, PostHog, Inngest, Vercel, and sample-product health scaffolds |
